                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            <div className="p-6 bg-gray-900 text-white">
                                <h3 className="text-lg font-bold mb-1">Jane Cooper</h3>
                                <p className="text-sm text-gray-400 mb-4">Marketing Coordinator</p>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            />
                            <div className="p-6 bg-gray-900 text-white">
                                <h3 className="text-lg font-bold mb-1">Darlene Robertson</h3>
                                <p className="text-sm text-gray-400 mb-4">Marketing Coordinator</p>
                                <div className="flex gap-2">
                                    <button className="w-8 h-8 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center transition-colors">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                            ...
                            />
                            <div className="p-6 bg-gray-900 text-white">
                                <h3 className="text-lg font-bold mb-1">Darrell Steward</h3>
                                <p className="text-sm text-gray-400 mb-4">Marketing Coordinator</p>
                                <div className="flex gap-2">
                                    <button className="w-8 h-8 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center transition-colors">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
